...
#Opções: https://github.com/kartikmadhira1/Traffic-Counter_OpenCV/blob/master/video.avi
#http://techspirityou.blogspot.com/2016/04/traffic-count-using-opencv-python.html
...
#AQUI: -> https://github.com/alex-drake/OpenCV-Traffic-Counter
## TODO: Fluxo de baixo pra cima não deve ser contado
import logging
...
if CAPTURE_FROM_VIDEO:
    IMAGE_SOURCE = "datasets/video-4.ogv" # Video file
    #IMAGE_SOURCE = "datasets/out-10_inv.avi" # Video file
else:
...
def save_frame(file_name_format, frame_number, frame, label_format):
    ...
    cv2.imwrite(file_name, frame) #MUDANCA
...
def process_frame(frame_number, frame, bg_subtractor, car_counter):
    ...
    #save_frame(IMAGE_DIR + "/imagens"+ "/mask_%04d.png", frame_number, fg_mask, "foreground mask for frame #%d") #SALVAR
...
def main():
    ...
    while True:
        ...
        if car_counter is None:
            ...
            car_counter = VehicleCounter(frame.shape[:2], frame.shape[0] * 1/2)
    ...
    print ("Veículos: %d" % car_counter.vehicle_count)
